...
use Hestabit\GoogleMerchant\Exception\InvalidArgumentException;
use Hestabit\GoogleMerchant\Product\Availability\Availability;
use Hestabit\GoogleMerchant\Product\Shipping;
...
class Product
{
     ...
     * @return $this
     */
    public function setItemGroupId($str)
    {
        $this->setAttribute('item_group_id', $str, false);
        return $this;
    }
    ...
    /**
     * Sets product detail of the product.
     *
    ...
    {
        $propertyBag = $productDetail->getPropertyBag()->setName('product_detail');
        $this->setAttribute('product_detail', $propertyBag);
        return $this;
    }

    /**
     * Adds product detail of the product.
     * 
     * @param Product $product_detail
     *
     * @return $this
    ...
    {
        $propertyBag = $productDetail->getPropertyBag()->setName('product_detail');
        $this->addAttribute('product_detail', $propertyBag);
        return $this;
    }
    ...
    {
        $propertyBag = $tax->getPropertyBag()->setName('tax');
        $this->addAttribute('tax', $propertyBag);
        return $this;
    }
}
